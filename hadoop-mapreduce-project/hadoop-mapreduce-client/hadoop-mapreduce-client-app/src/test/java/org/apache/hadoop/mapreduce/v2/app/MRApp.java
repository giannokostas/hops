...
public class MRApp extends MRAppMaster {
  ...
  protected class MockContainerLauncher implements ContainerLauncher {
    ...
    @Override
    public void handle(ContainerLauncherEvent event) throws IOException {
  ...
  protected void attemptLaunched(TaskAttemptId attemptID) throws IOException {
    if (autoComplete) {
      // send the done event
      getContext().getEventHandler().handle(
  ...
  protected class MRAppContainerAllocator
    ...
    private int containerCount;
     ...
     @Override
      public void handle(ContainerAllocatorEvent event) throws IOException {
        ContainerId cId =
